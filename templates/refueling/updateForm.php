...
<body>
    ...
    $operator = $personalRepository->getPersonal($refueling->personal_id);
    $affected_aeronef = $aeronefRepository->getAeronef($refueling->aeronef_id);
    ?>
    <div class="col-sm-9 col-xs-12 content pt-3 pl-0">
        <h5 class="mb-3"><strong>Update refueling</strong></h5>
        <div class="row">
            <div class="col-sm-12">
                <div class="mt-4 mb-3 p-3  button-container bg-white border shadow-sm">
                    <h6 class="mb-4">REFUELING</h6>
                    <form action="index.php?action=updateRefueling&refueling_id=<?= $refueling->refueling_id ?>" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="number" step="any" value='<?= $refueling->quantity ?>' class="form-control" id="quantity" name="quantity" required />
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label col-sm-3" for="REFUELING_DATE">REFUELING DATE</label>
                            <div class="col-sm-5">
                                <input type="date" value='<?= $refueling->refueling_date ?>' class="form-control" id="REFUELING_DATE" name="REFUELING_DATE" required />
                            </div>
                        </div>
                        <div class="form-group row">
