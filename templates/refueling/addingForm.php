...
<body>
    ...
    <div class="col-sm-9 col-xs-12 content pt-3 pl-0">
        <h5 class="mb-3"><strong>Add a new refueling</strong></h5>
        <div class="row">
            <div class="col-sm-12">
                <div class="mt-4 mb-3 p-3  button-container bg-white border shadow-sm">
                    <h6 class="mb-4">REFUELING</h6>
                    <form action="index.php?action=addRefueling" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <select class="custom-select" name="operator" id="operator" required>
                                    <option value="">Operator selection</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="date" class="form-control" id="REFUELING_DATE" name="REFUELING_DATE" required />
                            </div>
                        </div>
                        <div class="form-group row">
