...
<body>
    ...
    <div class="col-sm-9 col-xs-12 content pt-3 pl-0">
        <h5 class="mb-3"><strong>Add a new defueling</strong></h5>
        <div class="row">
            <div class="col-sm-12">
                <div class="mt-4 mb-3 p-3  button-container bg-white border shadow-sm">
                    <h6 class="mb-4">DEFUELING</h6>
                    <form action="index.php?action=addDefueling" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="date" class="form-control" id="DEFUELING_DATE" name="DEFUELING_DATE" required />
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label col-sm-3" for="REASON">REASON</label>
                            <div class="col-sm-5">
                                <textarea required type="text" class="form-control" rows="3" id="REASON" name="REASON"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
