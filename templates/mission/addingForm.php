...
<body>
    ...
    <div class="col-sm-9 col-xs-12 content pt-3 pl-0">
        <h5 class="mb-3"><strong>Add a new mission</strong></h5>
        <div class="row">
            <div class="col-sm-12">
                <div class="mt-4 mb-3 p-3  button-container bg-white border shadow-sm">
                    <h6 class="mb-4">MISSION</h6>
                    <form action="index.php?action=addMission" method="post">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <select class="custom-select" name="captain" id="captain" required>
                                    <option value="">Captain selection</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <textarea required type="text" class="form-control" rows="2" id="destination" name="destination"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <textarea required type="text" class="form-control" rows="3" id="beneficiary" name="beneficiary"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label col-sm-3" for="BSM">NUMBER OF PASSENGERS</label>
                            <div class="col-sm-5">
                                <input type="number" class="form-control" id="passengers_number" name="passengers_number" required />
                            </div>
                        </div>
                        <div class="form-group row">
