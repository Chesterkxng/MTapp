				...
				<div class="col-md-6 col-lg-4">
					<div class="login-wrap p-0">
						...
						<form action="index.php?action=redirectQA" method='post' class="signin-form">
							...
							<div class="form-group">
								<input id="password-field" type="password" id="Password" name="Password" class="form-control" placeholder=" New password" required>
							</div>
							<div class="form-group">
								<input id="password-field" type="password" id="Password2" name="Password2" class="form-control" placeholder="Confirm your new password" required>
							</div>
							<div class="form-group">
