...
class Mission
{
    ...
    public function addMission(array $input)
    {
        ...
        if ($input !== null) {
            ...
            $status = null;
            if (!empty($input['captain']) && !empty($input['type']) && !empty($input['affected_aeronef']) 
            ...
            $missionRepository = new MissionRepository(); 
            $missionRepository->connection = new DatabaseConnection(); 
            $success = $missionRepository-> addMission($captain, $type_id, $aeronef_id, $destination, $departure_date,
             $return_date, $passengers_number, $beneficiary, $status);
    ...
    public function updateMission(int $mission_id,array $input)
    {
        ...
        if ($input !== null) {
            ...
            $missionRepository = new MissionRepository(); 
            $missionRepository->connection = new DatabaseConnection(); 
            $success = $missionRepository-> updateMission($captain, $type_id, $aeronef_id, $destination, $departure_date,
             $return_date, $passengers_number, $beneficiary, $status, $mission_id);
