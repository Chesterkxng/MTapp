...
class Aeronef
{
    ...
    public function updadeAeronefPage(int $aeronef_id){
    ...
    public function updateAeronef($aeronef_id, $input)
    {
        ...
        if ($input !== null) {
            ...
            $lh_eng_dh = null;
            $availability = null;
            if (!empty($input['immatriculation']) && !empty($input['S_N']) && !empty($input['FH']) 
    ...
    public function setInactiveAeronef(int $aeronef_id)
    {
        $aeronefRepositoty = new AeronefRepository();
        $aeronefRepositoty->connection = new DatabaseConnection();
        $aeronef = $aeronefRepositoty->deleteApparentlyAeronef($aeronef_id);
