...
class Order
{
    ...
    public function addOrder(array $input)
    {
        ...
        if ($input !== null) {
            ...
            if (!empty($input['PN']) && !empty($input['name']) && !empty($input['supplier']) 
            ...
            if($status == 2 && $input['DELIVERY_DATE']!= ''){
                ...
                $success = $orderRepository->addNewDeliveredOrder($aeronef_id,$part_number,$name,$supplier
                ,$price, $quantity, $orderDate, $status, $deliveryDate);
                ...
                $success = $orderRepository->addNewPendingOrder($aeronef_id,$part_number,$name,$supplier
                ,$price, $quantity, $orderDate, $status);
    ...
    public function updateOrder(array $input, int $order_id)
    {
        ...
        if ($input !== null) {
            ...
            if($status == 2 && $input['DELIVERY_DATE']!= ''){
                ...
                $success = $orderRepository->updateToSetDeliveredOrder($aeronef_id,$part_number,$name,$supplier
                ,$price, $quantity, $orderDate, $status, $deliveryDate, $order_id);
                ...
                $success = $orderRepository->updatePendingOrder($aeronef_id,$part_number,$name,$supplier
                ,$price, $quantity, $orderDate, $status, $order_id);
